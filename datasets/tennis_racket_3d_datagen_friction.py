...
from envs.tennis_racket_3d_friction import tennis_racket_3d
...
def get_dataset(
    ...
    **kwargs
    ...
    filename = (
        ...
        f"_{fric_str}_{ncfg_str}_{steps_str}.pkl"
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--friction_coeff",    type=float, default=0.0)
